...
The hybrids are read out by ARC boards in combination with the old version of the ARC front-end adapter~\cite{arc}.
...
\begin{figure}
  \begin{center}
    \resizebox{0.75\textwidth}{!}{\includegraphics{fig/c1_hybpa_noise_shield_comparison.png}}
