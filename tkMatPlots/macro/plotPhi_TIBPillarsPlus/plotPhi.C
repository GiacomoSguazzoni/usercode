...
void plotPhi(){
  ...
  //
  //Raw
  TFile * rMCF = new TFile(dir+"rMC_Phi.root");
  TH1D * rMCH = (TH1D*) rMCF->Get("rMC_Phi");;
  //
  TFile * rSimF = new TFile(dir+"rSim_Phi.root");
  TH1D * rSimH = (TH1D*) rSimF->Get("rSim_Phi");;
  //
  TFile * rDataF = new TFile(dir+"rData_Phi.root");
  TH1D * rDataH = (TH1D*) rDataF->Get("rData_Phi");;
  //
  TFile * rFakeF = new TFile(dir+"rFake_Phi.root");
  TH1D * rFakeH = (TH1D*) rFakeF->Get("rFake_Phi");;
  //
  //Scaled
  TFile * SimF = new TFile(dir+"Sim_Phi.root");
  TH1D * SimH = (TH1D*) SimF->Get("Sim_Phi");;
  //
  TFile * MCF = new TFile(dir+"MC_Phi.root");
  TH1D * MCH = (TH1D*) MCF->Get("MC_Phi");;
  //
  TFile * MCFsF = new TFile(dir+"MCFakeSub_Phi.root");
  TH1D * MCFsH = (TH1D*) MCFsF->Get("MCFakeSub_Phi");;
  //
  TFile * FakeF = new TFile(dir+"MCFake_Phi.root");
  TH1D * FakeH = (TH1D*) FakeF->Get("MCFake_Phi");;
  //
  TFile * DataF = new TFile(dir+"Data_Phi.root");
  TH1D * DataH = (TH1D*) DataF->Get("Data_Phi");;
  //
  TFile * DataFsF = new TFile(dir+"DataFakeSub_Phi.root");
  TH1D * DataFsH = (TH1D*) DataFsF->Get("DataFakeSub_Phi");;
  //
  //Unfold Stuff
  if ( iUf ) {
  ...
  //  Double_t Max = 0.02;
  TH2F *frame1= new TH2F("frame1",";#phi (rad);Countings/event/dR",1.,rDataH->GetXaxis()->GetBinLowEdge(1),rDataH->GetXaxis()->GetBinUpEdge(rDataH->GetNbinsX()),1.,Min,Max);
  ...
  TH2F *frame2= new TH2F("frame2",";#phi (rad);#propto N_{#gamma} #times P/X_{0}/event",1.,DataH->GetXaxis()->GetBinLowEdge(1),DataH->GetXaxis()->GetBinUpEdge(DataH->GetNbinsX()),1.,Min,Max);
  ...
  TH2F *frame3= new TH2F("frame3",";#phi (rad);#propto N_{#gamma} #times P/X_{0}/event",1.,DataH->GetXaxis()->GetBinLowEdge(1),DataH->GetXaxis()->GetBinUpEdge(DataH->GetNbinsX()),1.,Min,Max);
  //  TH2F *frame2= new TH2F("frame2",";R (cm);X_{0}^{-1} (arbitrary units)",1.,DataH->GetXaxis()->GetBinLowEdge(1),DataH->GetXaxis()->GetBinUpEdge(DataH->GetNbinsX()),1.,Min,Max);
  ...
  TH2F *frame4= new TH2F("frame4",";#phi (rad);<1/X_{0}> (cm^{-1})",1.,DataH->GetXaxis()->GetBinLowEdge(1),DataH->GetXaxis()->GetBinUpEdge(DataH->GetNbinsX()),1.,Min,Max);
  //  TH2F *frame2= new TH2F("frame2",";R (cm);X_{0}^{-1} (arbitrary units)",1.,DataH->GetXaxis()->GetBinLowEdge(1),DataH->GetXaxis()->GetBinUpEdge(DataH->GetNbinsX()),1.,Min,Max);
