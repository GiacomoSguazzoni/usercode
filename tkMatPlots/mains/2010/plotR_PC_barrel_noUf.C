...
int main(){
  ...
  //#include "files_conv_mcreco_20100713.cxx"//PAS
  //#include "files_conv_mcreco_362_20100909.cxx"
...
//  convR2SforMatPlot convMC("../7TeV/ntuple_conversion_CMSSW358p3_minbias7TeV_2010-06-04_v2.root");
  myPlotR.FillMC(&convMC, 1, 900000000); 

  //MC Sim
  //
  //#include "files_conv_mcsim_20100619.cxx"
  //#include "files_conv_mcsim_20100713.cxx"//PAS
  //#include "files_conv_mcsim_362_20100909.cxx"
#include "src/files_conv_mcsim_386p1_20101124.cxx"
  ...
  myPlotR.FillSim(&convSim, 1, 900000000);

  //Data
  //
  //#include "files_conv_data_20100619.cxx"
  //#include "files_conv_data_20100713.cxx"//
  //#include "files_conv_x0max_362_20100909.cxx"
