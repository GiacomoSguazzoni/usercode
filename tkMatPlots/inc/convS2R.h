...
// Fri May 21 11:44:56 2010 by ROOT version 5.22/00b
// from TTree ntupleS2R/sim2reco
// found on file: ../7TeV/ntuple_conversion_CMSSW356_minbias7TeV_hit_2010-05-10.root
//////////////////////////////////////////////////////////
...
#ifdef convS2R_cxx
convS2R::convS2R(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../7TeV/ntuple_conversion_CMSSW356_minbias7TeV_hit_2010-05-10.root");
      if (!f) {
         f = new TFile("../7TeV/ntuple_conversion_CMSSW356_minbias7TeV_hit_2010-05-10.root");
      }
