...
// Tue Jul 13 11:12:48 2010 by ROOT version 5.22/00b
// from TTree ntupleR2S/reco2sim
// found on file: ../7TeV/ntuple_conversion_minbias7TeV_July12.root
//////////////////////////////////////////////////////////
...
#ifdef convR2S_cxx
convR2S::convR2S(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../7TeV/ntuple_conversion_minbias7TeV_July12.root");
      if (!f) {
         f = new TFile("../7TeV/ntuple_conversion_minbias7TeV_July12.root");
      }
