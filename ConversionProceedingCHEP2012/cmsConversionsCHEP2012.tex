...
\includegraphics[width=.45\textwidth]{fig/maxConvAlgo_r_Asso_Barrel_mod.png}}
\subfigure[]{
\label{subfig:fakeBarrel}
\includegraphics[width=.45\textwidth]{fig/maxConvAlgo_r_Fake_Barrel_mod.png}}
...
\includegraphics[trim=0cm 6.3cm 18.5cm 6cm, clip=true,width=.4\textwidth]{fig/singleLegCoverage.pdf}}
\subfigure[]{
