...
The aim of the present study is to derive the set of k-factors $\kvect^{\rm R}_{\rm min}$ ({\em minimal $X_0$ scenario}) and $\kvect^{\rm R}_{\rm max}$ ({\em maximal $X_0$ scenario})  corresponding to the minimal and maximal variations $\Delta \TX_{\rm min}$ and $\Delta \TX_{\rm max}$ compatible with the systematic uncertainties. Similar entities can be defined with respect to $\lambda_{\rm I}$: 
...
and~\ref{fig:lambda0minmax}. It is worth notice how a global mass change of $+5\%$ can translate into a local fractional change of $\TX$ and $\TI$ in the range $-3\%$ to $+8\%$ and $-3\%$ to $+10\%$, respectively, and a non trivial $\eta$ dependence.
