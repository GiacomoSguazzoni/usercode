...
\item[$X_0$] is the interaction length (in $cm$).%$\cm$
\end{description}
...
Similarly, in a cylindrical reference system $(r,z,\phi)$ ($r=R\sin\theta$, $z=R\cos\theta$)
\begin{equation}
...
In a cartesian reference system $(x, y, z)$ ($x=R\sin\theta\cos\phi$, $y=R\sin\theta\sin\phi$, $z=R\cos\theta$)
\begin{equation}
...
Equations~(\ref{eq:5}) with~(\ref{eq:10}),~(\ref{eq:5bis})
